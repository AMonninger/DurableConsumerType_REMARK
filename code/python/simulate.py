...
def optimal_choice(t, p, n, m, discrete, d, c, a, sol, par):
    ...
    inv_v_keep = linear_interp.interp_3d(
        par.grid_p, par.grid_n, par.grid_m, sol.inv_v_keep[t], p, n, m
    )
    ...
    if adjust:
        ...
        d[0] = linear_interp.interp_2d(par.grid_p, par.grid_x, sol.d_adj[t], p, x)

        c[0] = linear_interp.interp_2d(par.grid_p, par.grid_x, sol.c_adj[t], p, x)
        ...
        c[0] = linear_interp.interp_3d(
            par.grid_p, par.grid_n, par.grid_m, sol.c_keep[t], p, n, m
        )
...
def optimal_choice_2d(t, p, n1, n2, m, discrete, d1, d2, c, a, sol, par):
    # a. discrete choice
    inv_v = 0
    inv_v_keep = linear_interp.interp_4d(
        par.grid_p,
        par.grid_n,
        par.grid_n,
        par.grid_m,
    ...
    inv_v_adj_full = linear_interp.interp_2d(
        par.grid_p, par.grid_x, sol.inv_v_adj_full_2d[t], p, x_full
    )

    x_d1 = m + (1 - par.tau1) * n1
    inv_v_adj_d1 = linear_interp.interp_3d(
        par.grid_p, par.grid_n, par.grid_x, sol.inv_v_adj_d1_2d[t], p, n2, x_d1
    )

    x_d2 = m + (1 - par.tau2) * n2
    inv_v_adj_d2 = linear_interp.interp_3d(
        par.grid_p, par.grid_n, par.grid_x, sol.inv_v_adj_d2_2d[t], p, n1, x_d2
    )
    ...
    if keep:
        ...
        d1[0] = linear_interp.interp_2d(
            par.grid_p, par.grid_x, sol.d1_adj_full_2d[t], p, x_full
        )

        d2[0] = linear_interp.interp_2d(
            par.grid_p, par.grid_x, sol.d2_adj_full_2d[t], p, x_full
        )

        c[0] = linear_interp.interp_2d(
            par.grid_p, par.grid_x, sol.c_adj_full_2d[t], p, x_full
        )
        ...
        d1[0] = linear_interp.interp_3d(
            par.grid_p, par.grid_n, par.grid_x, sol.d1_adj_d1_2d[t], p, n2, x_d1
        )

        d2[0] = n2

        c[0] = linear_interp.interp_3d(
            par.grid_p, par.grid_n, par.grid_x, sol.c_adj_d1_2d[t], p, n2, x_d1
        )
        ...
        d2[0] = linear_interp.interp_3d(
            par.grid_p, par.grid_n, par.grid_x, sol.d2_adj_d2_2d[t], p, n1, x_d2
        )

        c[0] = linear_interp.interp_3d(
            par.grid_p, par.grid_n, par.grid_x, sol.c_adj_d2_2d[t], p, n1, x_d2
        )
