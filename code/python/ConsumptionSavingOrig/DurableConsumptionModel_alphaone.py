...
class DurableConsumptionModelClass(ModelClass):
    ...
    def setup(self):
        ...
        par.delta1 = 0.10
        par.delta2 = 0.20
        par.gamma = 1.00 #0.50  # note: the last_period.solve_2d function must be updated if this value is changed
        ...
        for t in reversed(range(self.par.T)):
            ...
            with jit(self) as model:
                ...
                # ii. all other periods
                    ...
                    nvfi.solve_adj(t, sol, par)  # HERE I NEED THE NVFI
