...
def solve(t, sol, par):
    ...
    for i_n in range(par.Nn):
        for i_m in range(par.Nm):
            ...
            inv_marg_u_keep[i_n, i_m] = 1.0 / utility.marg_func(
                c_keep[i_n, i_m], n, par
            )
    ...
    for i_x in range(par.Nx):
        ...
        d_adj[i_x] = golden_section_search.optimizer(
            obj_last_period, d_low, d_high, args=(x, par), tol=par.tol
        )
