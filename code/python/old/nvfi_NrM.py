...
def solve_adj(t,sol,par):
    ...
    for i_x in range(par.Nx):
        ...
        d[i_x] = golden_section_search.optimizer(obj_adj,d_low,d_high,args=(x,inv_v_keep,grid_n,grid_m),tol=par.tol)
        ...
        if par.do_marg_u:
            inv_marg_u[i_x] = 1/utility.marg_func_nopar(c[i_x],d[i_x],d_ubar,alpha,rho)
#    print(c-d)