...
def _discrete(model,t):
    ...
    linear_interp.interp_1d_vec(par.grid_x,model.sol.inv_v_adj[t,:,],x.ravel(),inv_v_adj)
...
def _egm(model,t,i_n):
    ...
    for i_a in range(par.Na):
        inv_v_vec[i_a] = utility.func(c_vec[i_a],par.grid_n[i_n],par) + (-1/sol.inv_w[t,i_n,i_a])
