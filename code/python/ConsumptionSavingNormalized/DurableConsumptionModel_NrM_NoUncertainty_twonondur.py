...
class DurableConsumptionModelClass_NrM_twonondur(ModelClass):
    ...
    def setup(self):
        ...
        par.sigma_psi = 0.0 #0.1
        par.Npsi = 7 #5
        par.sigma_xi = 0.0 #0.1
        par.Nxi = 7 #5
        par.pi = 0.0
        par.mu = 0.0 #0.5
        ...
        # simulation
        par.sigma_p0 = 0.0 #0.2
        par.mu_d0 = 0.8
        par.sigma_d0 = 0.0 #0.2
        par.mu_a0 = 0.2
        par.sigma_a0 = 0.0 #0.1
        par.simN = 100000
        par.sim_seed = 1998
