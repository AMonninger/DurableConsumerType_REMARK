...
def solve(t,sol,par):
    ...
    for i_n in range(par.Nn):
        for i_m in range(par.Nm):
            ...
            if m == 0: # forced c = 0
                c_keep[i_n,i_m] = 0
                inv_v_keep[i_n,i_m] = 0
                inv_marg_u_keep[i_n,i_m] = 0
                continue
            ...
            # iii. optimal value
            v_keep = utility.func(c_keep[i_n,i_m],n,par)
            inv_v_keep[i_n,i_m] = -1.0/v_keep
            inv_marg_u_keep[i_n,i_m] = 1.0/utility.marg_func(c_keep[i_n,i_m],n,par)
    ...
    for i_x in range(par.Nx):
        ...
        d_adj[i_x] = golden_section_search.optimizer(obj_last_period,d_low,d_high,args=(x,par),tol=par.tol)
        c_adj[i_x] = x-d_adj[i_x]

        # iii. optimal value
        v_adj = -obj_last_period(d_adj[i_x],x,par)
        inv_v_adj[i_x] = -1.0/v_adj
        inv_marg_u_adj[i_x] = 1.0/utility.marg_func(c_adj[i_x],d_adj[i_x],par)
    # print('par.Nx')
    # print(par.Nx)
    # print('d_adj')
    # print(d_adj)
